...
### 💡 exp63 — Sparse closure substrate (CSR + iterative solver)
...
### 💡 exp64 — Parity re-test with irregular counts (close the exp59C honest miss)
...
### 💡 exp65 — Extend TL tool-call to multi-relation joins (uncle = parent ∘ sibling)
